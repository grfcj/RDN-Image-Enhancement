...
flags.DEFINE_integer("image_size", 288, "the size of image input")
...
flags.DEFINE_integer("batch_size", 4, "the size of batch")
...
flags.DEFINE_integer("C",4, "C")
flags.DEFINE_integer("G", 16, "G")
flags.DEFINE_integer("G0", 16, "G0")
